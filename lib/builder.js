...
class Builder {
    ...
    static createProdConfig(options) {
        ...
        // 设置提取CSS为一个单独的文件的插件
        prodPlugins.push(this.setExtractTextPlugin(true, ''));
        if (options.minifyJS) {
            // 压缩JS
...
>>>>>>> de82ce45040ea50ad66410796791a0adf5e5adf1
    ...
    static setHappyPack(jsLoader, useTreeShaking) {
        ...
        /**
         * 这个地方硬编码的babel配置，是否应当交给脚手架的babelrc处理？
         */
        if (useTreeShaking) {
            presets = [[ "env", {
                "modules": false,
    ...
    /**
     * 设置Loader的path查找的目录
     * TODO: 这个地方是否应当把业务代码自己的node_modules也加入？
